                ...
                builder ? (
                  <StaggerItem key={builder.id}>
                    <Link href={`/app/builders/${builder.id}`}>
                      <TiltCard className="flex items-center gap-3 p-4 rounded-xl bg-[#141414] border border-[#1F1F1F] hover:border-[#2A2A2A] transition-colors cursor-pointer group">
                        <img
                          src={builder.avatar}
                          alt={builder.name}
                ...
                {team.openRoles.map((role) => {
                  ...
                  return (
                    <StaggerItem key={role}>
                      <div className="flex items-center justify-between p-3 rounded-xl bg-[#141414] border border-[#1F1F1F] hover:border-[#2A2A2A] transition-colors">
          ...
          return (
            <StaggerItem key={team.id}>
              <Link href={`/app/teams/${team.id}`}>
                <TiltCard className="p-5 rounded-xl bg-[#141414] border border-[#1F1F1F] hover:border-[#2A2A2A] transition-colors cursor-pointer group h-full flex flex-col">
